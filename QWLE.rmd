...
Here is the model fit against the training data and the resulting Accuracy. See Appedix for details.
...
Here is the model fit against the test/quiz data and the resulting Accuracy. See Appedix for details.
...
##Appendix
Below are the details of the final training and testing Confusion Matrixes.
